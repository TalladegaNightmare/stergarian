  ...
  return (
    <>
      <style>{`
       ...
       .line { font-family: var(--font-druk), 'Anton', sans-serif; font-weight: 400; color: #D42510; line-height: 0.95; letter-spacing: -0.01em; text-transform: uppercase; white-space: nowrap; }
