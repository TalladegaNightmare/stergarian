...
.line { font-family: var(--font-druk), 'Anton', sans-serif; font-weight: 400; color: #D42510; line-height: 0.95; letter-spacing: 0.02em; word-spacing: 0.08em; text-transform: uppercase; white-space: nowrap; }        .experiments { margin-top: 2.5rem; display: flex; flex-direction: column; align-items: center; animation: fadeIn 1.2s ease-out 0.4s both; }
