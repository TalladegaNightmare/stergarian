...
.line { font-family: var(--font-druk), 'Anton', sans-serif; font-weight: 400; color: #D42510; line-height: 0.95; letter-spacing: 0.02em; word-spacing: 0.08em; margin-bottom: -0.05em; text-transform: uppercase; white-space: nowrap; }        
.experiments { margin-top: 2.5rem; display: flex; flex-direction: column; align-items: center; gap: 0.75rem; animation: fadeIn 1.2s ease-out 0.4s both; }
.experiment-link { font-family: 'IBM Plex Mono', monospace; font-size: 1.5rem; letter-spacing: 0.14em; text-transform: uppercase; color: #D42510; text-decoration: none; border-bottom: 1px solid rgba(212,37,16,0.35); padding-bottom: 2px; transition: border-color 0.2s ease; }
